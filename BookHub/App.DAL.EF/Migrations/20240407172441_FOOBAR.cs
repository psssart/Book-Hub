        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMainGenre = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BooksWarehouses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BooksWarehouses_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BooksWarehouses_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Discussions_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Discussions_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookHasRead = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchasedBooks_Purchases_PurchaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersSubscriptions_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersSubscriptions_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Topics_Discussions_DiscussionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BooksWarehouses_BookId",
                table: "BooksWarehouses",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BooksWarehouses_WarehouseId",
                table: "BooksWarehouses",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasedBooks_PurchaseId",
                table: "PurchasedBooks",
                column: "PurchaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Topics_DiscussionId",
                table: "Topics",
                column: "DiscussionId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersSubscriptions_AppUserId",
                table: "UsersSubscriptions",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersSubscriptions_BookId",
                table: "UsersSubscriptions",
                column: "BookId");
        }
